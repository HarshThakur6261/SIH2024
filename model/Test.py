...
# Check MongoDB connection before initializing collections
if not check_mongo_connection():
    exit("Exiting application due to MongoDB connection failure")

# Initialize collections if connection is successful
